...
echo "Attempting to compile module10_jrenga2.exe"
...
nvcc -I "$CUDA_INCLUDE_PATH" -L "$NVCC_LIBRARY_PATH" -lOpenCL module10_jrenga2.cpp -o module10_jrenga2.exe

./module10_jrenga2.exe
